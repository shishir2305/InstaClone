...
const SignUpFormSchema = yup.object({
  ...
  username: yup
    .string()
    .min(4, "should be of  minimum 4 characters")
    .required("required field"),
  password: yup
    .string()
    ...
    <Formik
      ...
      onSubmit={async (values) => {
        try {
          ...
          Alert.alert(
            "Error while Signing Up, Try Again with different username or email"
          );
        }
      }}
    >
        ...
        <>
          ...
          >
            ...
            <TouchableOpacity onPress={() => navigation.goBack()}>
              <Text
                style={{ color: "#6880F5", fontWeight: "600", marginLeft: 2 }}
              >
                Log in
              </Text>
            </TouchableOpacity>
